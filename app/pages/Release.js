...
export default class Release extends React.Component{
    render(){
        return(
            ...
            <h3>Alfresco 5.2 Release Reports</h3>
            <ul>
                <li><Link activeClassName="active" to="/release/5.2/trend">Cloud defect trend chart</Link></li>
                <li><Link activeClassName="active" to="/release/5.2/defect/discovery">Cloud defect discovery chart</Link></li>
            </ul>
