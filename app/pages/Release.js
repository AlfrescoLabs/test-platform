    ...
    render(){
        return(
            ...
            <ul>
                ...
                <li><Link activeClassName="active" to="/release/cloud430/discovery">Cloud defect discovery chart</Link></li>
            </ul>
            <h3>Alfresco 5.1 Release Reports</h3>
            <ul>
                <li><Link activeClassName="active" to="/release/5.1/trend">defect trend chart</Link></li>
                <li><Link activeClassName="active" to="/release/5.1/discovery"> defect discovery chart</Link></li>
            </ul>
            </ContentLayout>
