...
class Xaxis extends React.Component{
    render(){
        ...
        <g className="tick" transform="translate(15.888128466996104,0)" style={{"opacity": 1}}><line y2="6" x2="0"></line><text dy=".71em" y="9" x="0" style={{"textAnchor": "middle"}}>November</text></g>
